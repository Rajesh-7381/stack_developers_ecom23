                                        ...
                                        <td>
                                            <div class="table-p__box">
                                                <div class="table-p__img-wrap">
                                                    ...
                                                    <img class="u-img-fluid" src="{{ asset('admin-assets/front/products/small/'.$item['product']['images'][0]['image']) }}" alt="">
                                                @else
                                                  <img class="u-img-fluid" src="{{ asset('admin-assets/front/products/small/.sitemakers-tshirt.png') }}" alt="">
                            
                                                @endif                                                </div>
                                                    {{-- <img class="u-img-fluid" src="images/product/sitemakers-tshirt.png" alt=""></div> --}}
                                                <div class="table-p__info">
                                                    <span class="table-p__name">
                                                        <a href="{{url('product/'.$item['id'])}}">{{ $item['product']['product_name'] }}</a></span>
                    ...
                    <div class="col-lg-12">
                        <div class="route-box">
                            <div class="route-box__g1">
                                ...
                                <a class="route-box__link" href="{{route('fronthome')}}"><i class="fas fa-long-arrow-alt-left"></i>
